...
content.append(
    Paragraph(
        f"Organization: {session.get('organization_name', '-')}",
        styles['Normal']
    )
)
...
content.append(
    Paragraph(f"Completion Rate : {completion_rate}%", styles['Normal'])
)

content.append(
    Paragraph(f"Missed Rate : {missed_rate}%", styles['Normal'])
)
...
content.append(
    Paragraph("Generated by Toknify", styles['Italic'])
)
